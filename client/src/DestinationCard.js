    ...
    return(
        ...
        <img className="card-img-bottom " src={image} alt={`${city}, ${country}`}></img>
            <div className="card-body d-flex flex-column">
                ...
                <button className="btn btn-primary text-white" href="/reviewpage "><Link className='text-white' style={{ textDecoration: 'none' }} to={`/destination/${id}` }>Leave a review</Link></button>
            </div>
        </div>
    )
}
